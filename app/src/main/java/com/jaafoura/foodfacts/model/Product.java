...
public class Product {
  ...
  @Expose
  private List<Object> tracesTags = null;
  ...
  @Expose
  private List<String> storesTags = null;
  ...
  @Expose
  private List<String> purchasePlacesTags = null;
  ...
  @Expose
  private List<String> allergensHierarchy = null;
  ...
  @Expose
  private List<Object> genericNameFrDebugTags = null;
  ...
  @Expose
  private List<Object> originsTags = null;
  ...
  @Expose
  private List<Object> tracesHierarchy = null;
  ...
  @Expose
  private List<Object> productNameDebugTags = null;
  @SerializedName("product_name_fr_debug_tags")
  @Expose
  private List<Object> productNameFrDebugTags = null;
  ...
  @Expose
  private List<Object> ingredientsTextFrDebugTags = null;
  ...
  public Product(Long ingredientsFromOrThatMayBeFromPalmOilN, List<Object> tracesTags,
      List<String> ingredientsIdsDebug, Long additivesN, String nutritionGradeFr,
      List<Object> brandsDebugTags, List<Object> tracesDebugTags, String imageIngredientsUrl,
      String imageNutritionThumbUrl, String maxImgid, Long lastModifiedT, List<String> storesTags,
      String pnnsGroups2, String imageThumbUrl, List<Object> nutritionDataPerDebugTags,
      Long nutritionScoreWarningNoFruitsVegetablesNuts, Long ingredientsThatMayBeFromPalmOilN,
      List<String> codesTags, Long ingredientsFromPalmOilN, String imageNutritionUrl,
      List<String> purchasePlacesTags, String imageFrontUrl, List<String> labelsPrevTags,
      List<Object> checkersTags, String expirationDate, List<String> ingredientsTags,
      List<Object> ingredientsFromPalmOilTags, List<Object> packagingDebugTags, String states,
      String productName, List<String> manufacturingPlacesTags, String allergens,
      List<String> entryDatesTags, List<Ingredient> ingredients, String embCodesOrig,
      String origins, String labels, String nutritionDataPer, List<Object> unknownNutrientsTags,
      String quantity, List<String> languagesHierarchy, String imageIngredientsThumbUrl,
      Long lastImageT, Long servingQuantity, List<String> packagingTags,
      List<String> additivesOldTags, String ingredientsTextFr, String nutritionScoreDebug,
      String interfaceVersionCreated, List<String> ingredientsDebug, String manufacturingPlaces,
      String pnnsGroups1, Long rev, List<String> statesHierarchy, String lastEditor,
      Long completedT, List<String> additivesPrevOriginalTags, String lang,
      List<String> labelsTags, String ingredientsTextWithAllergensFr,
      List<Object> embCodesDebugTags, List<Object> categoriesDebugTags, Long createdT,
      String productNameFr, List<String> allergensHierarchy, List<String> languagesTags,
      List<Object> quantityDebugTags, List<String> correctorsTags,
      List<Object> countriesDebugTags, Images images, String lastModifiedBy, String embCodes,
      String link, List<Object> storesDebugTags, String imageIngredientsSmallUrl,
      String packaging, String stores, Long uniqueScansN, String ingredientsN,
      List<String> statesTags, List<String> ingredientsNTags, List<String> lastEditDatesTags,
      List<String> photographersTags, String genericNameFr, List<Object> genericNameFrDebugTags,
      String traces, String imageSmallUrl, List<Object> originsTags, String noNutritionData,
      String idd, List<Object> labelsDebugTags, Long sortkey,
      List<Object> manufacturingPlacesDebugTags, List<String> brandsTags,
      List<String> nutritionGradesTags, Long additivesPrevN, String code, List<String> miscTags,
      Languages languages, List<String> labelsPrevHierarchy, NutrientLevels nutrientLevels,
      List<String> pnnsGroups2Tags, String nutritionGrades, List<String> categoriesPrevHierarchy,
      LanguagesCodes languagesCodes, List<String> categoriesPrevTags,
      List<Object> originsDebugTags, List<Object> langDebugTags, List<Object> embCodesTags,
      List<String> lastImageDatesTags, String ingredientsTextWithAllergens,
      String imageFrontSmallUrl, String ingredientsText, List<String> categoriesHierarchy,
      String additivesPrev, String interfaceVersionModified, List<Object> tracesHierarchy,
      List<String> debugParamSortedLangs, String lc, SelectedImages selectedImages,
      List<Object> citiesTags, List<String> categoriesTags, List<Object> servingSizeDebugTags,
      List<String> informersTags, List<String> pnnsGroups1Tags, String additives,
      String imageNutritionSmallUrl, List<Object> ingredientsThatMayBeFromPalmOilTags,
      Long additivesOldN, String ingredientsTextDebug, List<Object> productNameDebugTags,
      List<Object> productNameFrDebugTags, List<String> editorsTags,
      List<String> additivesPrevTags, String imageFrontThumbUrl, List<String> nutrientLevelsTags,
      Long scansN, String servingSize, List<String> countriesTags, String id,
      List<Object> purchasePlacesDebugTags, List<String> additivesOriginalTags, String creator,
      String imageUrl, Nutriments nutriments, List<String> keywords, List<String> labelsHierarchy,
      List<Object> ingredientsTextFrDebugTags, List<String> countriesHierarchy,
      List<Object> expirationDateDebugTags, String purchasePlaces, String categories,
      String countries, String genericName, List<Object> linkDebugTags,
      List<String> allergensTags, String updateKey, Long complete, String brands,
      List<String> additivesTags, List<Object> additivesDebugTags) {
    ...
    this.productNameDebugTags = productNameDebugTags;
  ...
  public void setIngredientsFromOrThatMayBeFromPalmOilN(
      Long ingredientsFromOrThatMayBeFromPalmOilN) {
    this.ingredientsFromOrThatMayBeFromPalmOilN = ingredientsFromOrThatMayBeFromPalmOilN;
  }
  ...
  public void setTracesTags(List<Object> tracesTags) {
    this.tracesTags = tracesTags;
  }
  ...
  public Long getNutritionScoreWarningNoFruitsVegetablesNuts() {
    return nutritionScoreWarningNoFruitsVegetablesNuts;
  }

  public void setNutritionScoreWarningNoFruitsVegetablesNuts(
      Long nutritionScoreWarningNoFruitsVegetablesNuts) {
  ...
  public List<Object> getGenericNameFrDebugTags() {
    return genericNameFrDebugTags;
  }

  public void setGenericNameFrDebugTags(List<Object> genericNameFrDebugTags) {
    this.genericNameFrDebugTags = genericNameFrDebugTags;
  }
  ...
  public List<Object> getOriginsTags() {
    return originsTags;
  }

  public void setOriginsTags(List<Object> originsTags) {
    this.originsTags = originsTags;
  }
  ...
  public Long getAdditivesPrevN() {
    return additivesPrevN;
  }

  public void setAdditivesPrevN(Long additivesPrevN) {
    this.additivesPrevN = additivesPrevN;
  }
  ...
  public List<Object> getTracesHierarchy() {
    return tracesHierarchy;
  }

  public void setTracesHierarchy(List<Object> tracesHierarchy) {
    this.tracesHierarchy = tracesHierarchy;
  }
  ...
  public void setIngredientsThatMayBeFromPalmOilTags(
      List<Object> ingredientsThatMayBeFromPalmOilTags) {
    this.ingredientsThatMayBeFromPalmOilTags = ingredientsThatMayBeFromPalmOilTags;
  }
  ...
  public List<Object> getProductNameDebugTags() {
    return productNameDebugTags;
  }

  public void setProductNameDebugTags(List<Object> productNameDebugTags) {
    this.productNameDebugTags = productNameDebugTags;
  }

  public List<Object> getProductNameFrDebugTags() {
    return productNameFrDebugTags;
  }

  public void setProductNameFrDebugTags(List<Object> productNameFrDebugTags) {
    this.productNameFrDebugTags = productNameFrDebugTags;
  }
  ...
  public List<Object> getIngredientsTextFrDebugTags() {
    return ingredientsTextFrDebugTags;
  }

  public void setIngredientsTextFrDebugTags(List<Object> ingredientsTextFrDebugTags) {
    this.ingredientsTextFrDebugTags = ingredientsTextFrDebugTags;
  }
